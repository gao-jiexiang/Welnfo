...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    static final int ITEM_SHARE_LOCATION = 4;

    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location, R.string.share_location};
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.ease_chat_location_selector};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION, ITEM_SHARE_LOCATION};
...
//        messageList.setAvatarShape(1);
    ...
    public void go2ShareLocation() {
        //toChatUsername
        MapActivity.startAct(getContext(),toChatUsername);
    }
    ...
    private void sendShareLocationMsg() {
        //文本消息
        EMMessage message = EMMessage.createTxtSendMessage("好友共享了位置", toChatUsername);

        // 增加自己特定的属性
        message.setAttribute("share", true);
        sendMessage(message);
    }
